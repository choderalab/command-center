...
labmanagement.Employee = Backbone.Model.extend({

    urlRoot:"/directory-rest-php/employees",
//    urlRoot:"http://localhost:3000/employees",

    initialize:function () {
        this.reports = new labmanagement.EmployeeCollection();
        this.reports.url = this.urlRoot + "/" + this.id + "/reports";
    }

});

labmanagement.EmployeeCollection = Backbone.Collection.extend({

    model: labmanagement.Employee,

    url:"/directory-rest-php/items"
